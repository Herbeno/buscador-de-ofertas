...
def collect_gpus(search_term: str = "RTX 3060"):
    """
    Coleta dados de GPUs do Mercado Livre usando melhores práticas de locators.
...
if __name__ == "__main__":
    # Mantém o comportamento original se rodado diretamente
    results = collect_gpus()
    if results:
